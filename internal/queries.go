...
var number_hours_kg_not_running = sum_over_time_and_step(kg_not_running, "1w", "10m")
var total_number_hours = fmt.Sprintf("168 - (%s)", sum_over_time_and_step(non_reliable_value, "1w", "10m"))

var estimmated_co2_emission_no_kg = fmt.Sprintf("(%s) * 1008 / (%s)", sum_over_time_and_step(co2_emission_no_kg, "1w", "10m"), number_hours_kg_not_running)
var saved_co2_emission = fmt.Sprintf("(%s) - (%s)", estimmated_co2_emission_no_kg, sum_over_time_and_step(co2_emission, "1w", "10m"))
